...
@property (nonatomic) PCOBeveragesTableViewController       *beveragesTableViewController;
@property (nonatomic) PCOBeverageDetailTableViewController  *beverageDetailTableViewController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.beveragesTableViewController = [[PCOBeveragesTableViewController alloc] initWithNibName:nil bundle:nil];
